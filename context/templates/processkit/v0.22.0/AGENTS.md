...
|---|---|---|
| **A — installer** | Installer substitutes at render time (`aibox`, `v0.22.0`). | If still literal, read `aibox.toml` or ask the owner. |
...
<sub>Scaffolded by processkit `v0.22.0` on `2026-04-26`. Re-rendered on each installer sync.</sub>
