...
**Status:** pending
**aibox CLI:** v0.17.14 → v0.17.12
**processkit:** vlatest

## Summary

aibox has been updated from v0.17.14 to v0.17.12. Review each section below
...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.11.1/AGENTS.md context/templates/processkit/vlatest/AGENTS.md`
...
processkit is pinned to `vlatest` (upgraded from `v0.11.1` — aibox.toml now targets `vlatest`) (source: `https://github.com/projectious-work/processkit.git`).
