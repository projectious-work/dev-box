...
- **`images/`** — The published images that OTHER projects consume.
  These are the base image and 5 derived flavors that get pushed to GHCR.
...
image = "python-latex"                 # one of: base, python, latex, rust, python-latex, rust-latex
...
Six images built from `images/` and published to GHCR:
...
struct DevBoxSection {
    version: String,
    image: String,     // enum: base, python, latex, rust, python-latex, rust-latex
